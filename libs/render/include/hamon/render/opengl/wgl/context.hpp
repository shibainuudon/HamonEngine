...
#ifndef HAMON_RENDER_OPENGL_WGL_CONTEXT_HPP
#define HAMON_RENDER_OPENGL_WGL_CONTEXT_HPP

#include <hamon/window.hpp>
#include <hamon/render/opengl/wgl/wglext.hpp>
...
#endif // HAMON_RENDER_OPENGL_WGL_CONTEXT_HPP
