...
inline ::D3D11_STENCIL_OP StencilOperation(render::StencilOperation op)
{
	...
	case render::StencilOperation::IncrementAndClamp:	return D3D11_STENCIL_OP_INCR_SAT;
	case render::StencilOperation::DecrementAndClamp:	return D3D11_STENCIL_OP_DECR_SAT;
	case render::StencilOperation::Invert:				return D3D11_STENCIL_OP_INVERT;
	case render::StencilOperation::IncrementAndWrap:	return D3D11_STENCIL_OP_INCR;
	case render::StencilOperation::DecrementAndWrap:	return D3D11_STENCIL_OP_DECR;
	}
