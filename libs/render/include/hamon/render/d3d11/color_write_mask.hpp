...
#ifndef HAMON_RENDER_D3D11_COLOR_WRITE_MASK_HPP
#define HAMON_RENDER_D3D11_COLOR_WRITE_MASK_HPP
...
inline ::UINT8 ColorWriteMask(std::uint32_t mask)
{
	::UINT8 result = 0;
...
#endif // HAMON_RENDER_D3D11_COLOR_WRITE_MASK_HPP
