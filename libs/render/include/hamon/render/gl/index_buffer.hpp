...
#ifndef HAMON_RENDER_GL_INDEX_BUFFER_HPP
#define HAMON_RENDER_GL_INDEX_BUFFER_HPP

#include <hamon/render/gl/buffer.hpp>
#include <hamon/render/gl/gl.hpp>
#include <hamon/render/gl/index_type.hpp>
...
#endif // HAMON_RENDER_GL_INDEX_BUFFER_HPP
