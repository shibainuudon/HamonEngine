...
#ifndef HAMON_RENDER_GL_RASTERIZER_STATE_HPP
#define HAMON_RENDER_GL_RASTERIZER_STATE_HPP

#include <hamon/render/rasterizer_state.hpp>
#include <hamon/render/gl/cull_mode.hpp>
#include <hamon/render/gl/fill_mode.hpp>
#include <hamon/render/gl/front_face.hpp>
...
#endif // HAMON_RENDER_GL_RASTERIZER_STATE_HPP
